...
const generateTypes = () => {
  ...
  log(colors.yellow, `📋 Found ${namespaces.length} namespaces`);
  ...
  log(colors.green, `✅ Type definitions generated successfully!`);
  log(colors.green, `📄 Output: ${OUTPUT_FILE}\n`);
};
